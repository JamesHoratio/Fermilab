...
SETUP_DELAY = 0.350  # 350 ms delay after setup commands
QUERY_DELAY = 0.150  # 150 ms delay after query commands
LONG_COMMAND_DELAY = 3  # 3 seconds delay for long commands like RST
