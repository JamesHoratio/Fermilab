...
class BroomK6221:
    ...
    def init_2182A(self):
        commands = [
            ...
            'SYST:COMM:SER:SEND ":SYST:REM"',
            'SYST:COMM:SER:SEND ":SENS:FUNC \'VOLT:DC\'"',
            'SYST:COMM:SER:SEND ":SENS:CHAN 1"',
            'SYST:COMM:SER:SEND ":SENS:VOLT:RANG 0.1"',
            'SYST:COMM:SER:SEND ":TRIG:COUN 11"',  # Set number of measurements
            'SYST:COMM:SER:SEND ":SENS:VOLT:AZER:STAT ON"',
            'SYST:COMM:SER:SEND ":SENS:DEL:TRAN ON"',
            'SYST:COMM:SER:SEND ":SYST:ZCH ON"',
            'SYST:COMM:SER:SEND ":SYST:ZCH:STAT ON"',
            'SYST:COMM:SER:SEND ":SYST:ZCORR:ACQ"'
        ]
