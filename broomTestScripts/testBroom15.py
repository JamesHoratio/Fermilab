...
class PulseIVSweep:
    ...
    def configure_instruments(self):
        ...
        #self.send_command_to_2182A('SYST:ZCH OFF')
        #self.send_command_to_2182A('SENS:FUNC "VOLT"')
        #self.send_command_to_2182A('SENS:VOLT:CHAN 1')
        #self.send_command_to_2182A('SENS:VOLT:MODE NORM')
        #self.send_command('SYST:COMM:SER:CONT REM')
    ...
    def configure_2182A(self):
        ...
        self.wait_for_completion_2182A()
        #statmeasquery = (self.query_command_to_2182A('stat:meas?'))
        #print(f"Stat Meas Query: {statmeasquery}")
        ...
        self.wait_for_completion_2182A()
        #self.send_command_to_2182A(':TRIG:SOUR EXT')
        self.wait_for_completion_2182A()
        ...
        #self.send_command_to_2182A(':INITiate')
    ...
    def setup_pulse(self):# phigh, plow, width, sdel):
        ...
        self.send_command('SOURce:CURRent:STOP 0.01')  # Set stop current to 0.01
        self.send_command('SOURce:CURRent:STEP 0.001') # Set current step to 0.001
        self.wait_for_completion()
        self.send_command('SOUR:PDEL:HIGH 0.01')
        self.wait_for_completion()
        self.send_command('SOUR:PDEL:LOW 0')
        self.wait_for_completion()
        self.send_command('SOUR:PDEL:WIDTh 500e-6')
        self.wait_for_completion()
        self.send_command('SOUR:PDEL:SDEL 500e-6')
        self.wait_for_completion()
        ...
        self.wait_for_completion()
        self.send_command('SOUR:PDEL:SWE ON')  # Turn on the pulse sweep mode
    ...
    def run(self):
        self.setup_pulse()#phigh=0.01, plow=0, width=500e-9, sdel=500e-9)
        self.user_check()
        self.perform_sweep()
        self.send_command('SOUR:SWE:ABORT')
        self.wait_for_completion()
